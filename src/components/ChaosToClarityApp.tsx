...
const DOCUMENT_ID = import.meta.env.VITE_DOCUMENT_ID || 'ctc-id'
...
export default function ChaosToClarityApp() {
  ...
  const [document, { update: updateDocument }] = useSyncDocument<z.infer<typeof responseSchema>>(DOCUMENT_ID)
